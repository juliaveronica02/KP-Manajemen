...
class CreateStockComponent extends Component {
    ...
    constructor(props) {
        ...
        this.changeaddQuantityHandler = this.changeaddQuantityHandler.bind(this);
    ...
    saveOrUpdateDish = (e) => {
        e.preventDefault();
        let dish = {dish_id: this.state.dish_id, addQuantity: this.state.addQuantity};
    ...
    changeaddQuantityHandler= (event) => {
                                ...
                                <div className = "card-body">
                                    <form>
                                        ...
                                        <div className = "form-group">
                                            ...
                                            <input placeholder="Example: 20" name="addQuantity" className="form-control" 
                                                value={this.state.addQuantity} onChange={this.changeaddQuantityHandler}/>
                                        </div>
