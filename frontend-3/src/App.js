...
// ------- DISH -----------
import CreateDish from './Pages/Dish/add'  
import DishList from './Pages/Dish/list'  
import EditDish from "./Pages/Dish/update"; 
// ------- END -----------
  ...
  return (
    ...
    <Router>
      ...
      <div>
        ...
        <Route path = "/create" component = {CreateDish}></Route>
        <Route path = "/edit/:id" component = {EditDish}></Route>
